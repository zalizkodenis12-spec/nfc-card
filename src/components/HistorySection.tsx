        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-body leading-relaxed font-medium">
            {currentTheme.id === "instagram"
              ...
              : currentTheme.id === "dws"
              ? "Програмуємо картку під ваш сайт, портфоліо чи бренд, перевіряємо що вона працює на будь-якому телефоні, після чого відправляємо Новою поштою чи Укрпоштою."
        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-body leading-relaxed font-medium">
            {currentTheme.id === "instagram"
              ...
              : currentTheme.id === "dws"
              ? "Ставите картку на стійці або касі. Клієнт підносить телефон — і за секунду вже на вашому сайті."
