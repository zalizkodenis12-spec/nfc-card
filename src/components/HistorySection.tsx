    ...
    <section id="history" className="relative w-full bg-brand-bg z-10 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-brand-bg flex flex-col py-16 md:py-[20vh] px-6 md:px-24">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-body leading-relaxed font-medium">
            {currentTheme.id === "instagram"
              ? "Програмуємо картку під ваш Instagram-профіль, перевіряємо що вона працює на будь-якому телефоні, після чого відправляємо Новою поштою чи Укрпоштою."
              : currentTheme.id === "dws"
              ? "Розробляємо картку за вашим дизайном та програмуємо під потрібне вам посилання чи соцмережу, перевіряємо що вона працює на будь-якому телефоні, після чого відправляємо Новою поштою чи Укрпоштою."
              : "Програмуємо картку під ваш профіль або посилання, перевіряємо що вона працює на будь-якому телефоні, після чого відправляємо Новою поштою чи Укрпоштою."}
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-body leading-relaxed font-medium">
            {currentTheme.id === "instagram"
              ? "Ставите картку на стійці або касі. Клієнт підносить телефон — і за секунду вже у вашому Instagram-профілі."
              : currentTheme.id === "dws"
              ? "Ставите картку на стійці або касі. Клієнт підносить телефон — і за секунду вже відкриває ваше посилання чи профіль."
              : "Ставите картку на стійці або касі. Клієнт підносить телефон — і за секунду вже на потрібній сторінці для відгуку."}
          </p>
        </motion.div>
