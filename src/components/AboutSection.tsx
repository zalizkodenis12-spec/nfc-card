...
export default function AboutSection() {
  ...
  const baseMarquee =
    currentTheme.id === "instagram"
      ...
      : currentTheme.id === "dws"
      ? "DWS CARDS • ВЛАСНИЙ ДИЗАЙН • БУДЬ-ЯКЕ ПОСИЛАННЯ • "
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-medium max-w-4xl mx-auto leading-relaxed mb-8 md:mb-24">
            {currentTheme.id === "instagram"
              ...
              : currentTheme.id === "dws"
              ? "Хочете картку в фірмових кольорах свого бренду чи під іншу платформу (TikTok, Telegram, сайт, меню)? Створимо унікальний дизайн з вашим логотипом під будь-яке завдання."
              : "Клієнти рідко пишуть відгуки самі — їм ліньки шукати вас у пошуку чи возитись з QR-кодом. NFC-картка прибирає всі зайві кроки: один дотик — і залишити відгук простіше простого."}
          </p>
        </motion.div>
