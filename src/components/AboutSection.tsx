        ...
        >
          ...
          <p className="text-xl md:text-3xl font-medium max-w-4xl mx-auto leading-relaxed mb-8 md:mb-24">
            {currentTheme.id === "instagram"
              ...
              : currentTheme.id === "dws"
              ? "Клієнтам ліньки шукати ваш сайт чи вводити посилання вручну. NFC-картка прибирає всі зайві кроки: один дотик — і ваша сторінка миттєво відкрита на телефоні."
