        ...
        >
          ...
          <p className="text-xl md:text-3xl font-medium max-w-4xl mx-auto leading-relaxed mb-8 md:mb-24">
            {currentTheme.id === "instagram"
              ...
              : currentTheme.id === "dws"
              ? "Клієнти рідко переходять за посиланням самі — їм ліньки шукати вас в інтернеті чи возитись з QR-кодом. NFC-картка прибирає всі зайві кроки: один дотик — і перейти до вас простіше, ніж не перейти."
