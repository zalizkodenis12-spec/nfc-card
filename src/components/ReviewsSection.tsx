...
const REVIEWS = [
  {
    name: "Олена К.",
    role: "клієнтка",
    text: "Поставили картку на касу тижня два тому — відгуків стало реально більше. Люди самі кажуть, що це максимально зручно і не треба нічого шукати вручну.",
    rating: 5,
  },
  {
    name: "Максим П.",
    role: "клієнт",
    text: "Раніше у нас стояв звичайний QR-код і половина клієнтів просто не хотіла витрачати час. З NFC-карткою все значно простіше: підніс телефон, натиснув — і готово.",
    rating: 5,
  },
  {
    name: "Марина В.",
    role: "клієнтка",
    text: "Замовила картку під свій салон, дизайн у наших фірмових кольорах зробили за пару днів. На стійці виглядає сучасно та значно акуратніше за роздрукований QR.",
    rating: 5,
  },
];
