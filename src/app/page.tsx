        ...
        >
          ...
          <div className="hidden md:flex flex-1 w-full items-center justify-evenly font-sans font-extrabold text-sm tracking-widest uppercase text-white pl-8 lg:pl-16 z-[60]">
            ...
            >
              ...
              {totalCount > 0 && (
                <span className="absolute -top-1 -right-1.5 bg-[#90CAF9] text-black font-black text-[11px] min-w-[20px] h-[20px] px-1 rounded-full flex items-center justify-center shadow-md border border-white/20">
                  {totalCount}
                </span>
              )}
            </button>
          ...
          >
            ...
            {totalCount > 0 && (
              <span className="absolute 0 top-0.5 right-0 bg-[#90CAF9] text-black font-black text-[10px] min-w-[18px] h-[18px] px-1 rounded-full flex items-center justify-center shadow-md border border-white/20">
                {totalCount}
              </span>
            )}
          </button>
